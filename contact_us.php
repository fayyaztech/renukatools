                        ...
                        <div class="row contact-info" style="padding-left: 15px;" >
                            ...
                            <div class="col-md-3 card-border">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-md-9">
                                        <ul>
                                            <li><i class="fa fa-envelope"></i><b style="font-size: 14px;"><a href="mailto:sales@renukatools.in">sales@renukatools.in</a><br><a href="mailto:sales_aur@renukatools.in">sales_aur@renukatools.in</a></b></li>
                                            <li><i class="fa fa-phone"></i> <b style="font-size: 14px;" ><a href="tel:+91 9922438439">+91 9922438439</a><br><a href="tel:+91 9511919094">+91 9511919094</a></b></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-md-10">
                                        <ul>
                                            <li style="font-size: 14px;" > <i class="fa fa-envelope" style="font-size: 25px;" ></i> &nbsp; For job related enquiries, please send across your resume at <a href="mailto:info@renukatools.in"><b style="font-size: 14px;" >info@renukatools.in</b></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
