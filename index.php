            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active"> <img class="d-block w-100" src="include/img/Slider/Micro Bore Units.jpg" alt="Micro Bore Units">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">Micro Bore Units</h2> <a href="cartridges_micro_bore_units_mbu.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
                <div class="carousel-item"> <img class="d-block w-100" src="include/img/Slider/Fine Boring Bar With MBU.jpg" alt="Fine Boring Bar With MBU">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">Fine Boring Bar With MBU</h2> <a href="fine_boring_bars_with_micro_bore_units.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
                <div class="carousel-item"> <img class="d-block w-100" src="include/img/Slider/Eccentric Fine Boring Tools.jpg" alt="Eccentric Fine Boring Tools">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">Eccentric Fine Boring Tools</h2> <a href="eccentric_fine_boring_tools.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
                <div class="carousel-item"> <img class="d-block w-100" src="include/img/Slider/Duo Boring Bars.jpg" alt="Duo Boring Bars">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">Duo Boring Bars</h2> <a href="rough_boring_bars_duo_boring_bars.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
                <div class="carousel-item"> <img class="d-block w-100" src="include/img/Slider/Boring Kit.jpg" alt="Boring Kit">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">Boring Kit</h2> <a href="boring_kit.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
                <div class="carousel-item"> <img class="d-block w-100" src="include/img/Slider/BCA Boring Bars.jpg" alt="BCA Boring Bars">
                    <div class="carousel-caption fadeInRight">
                        <h2 class="carousel-text">BCA Boring Bars</h2> <a href="bca_boring_bars.php?product_category=std_products" class="btn btn-default" target="_blank">View More</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container pb-50">
        <div class="product-details-inner">
            <div class="pb-50 mobile-slider-std">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Standard Product Offerings</h3>
                    </div>
                </div>
                <br>
                <div class="row">
                            ...
                            <div class="product-slider-box slick-row-15 slick-arrow-style">
                                <div class="pro-large-img"> <img src="include/img/Micro Bore Units/Introduction/micro_bore_units_small.jpg" alt="Micro Bore Units" />
                                    <div class="mini-slider-footer">
                                        <a href="cartridges_micro_bore_units_mbu.php?product_category=std_products" target="_blank">
                                            <h6>Micro Bore Units</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Fine Boring Bars - MBU/Introduction/Small 1.jpg" alt="Fine Boring Bar With MBU" />
                                    <div class="mini-slider-footer">
                                        <a href="fine_boring_bars_with_micro_bore_units.php?product_category=std_products" target="_blank">
                                            <h6>Fine Boring Bar With MBU</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Eccentric Fine Boring Tools/Introduction/Small 1.jpg" alt="Eccentric Fine Boring Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="eccentric_fine_boring_tools.php?product_category=std_products" target="_blank">
                                            <h6>Eccentric Fine Boring Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/DUO_Introduction/Introduction/Small 1.jpg" alt="Duo Boring Bars" />
                                    <div class="mini-slider-footer">
                                        <a href="rough_boring_bars_duo_boring_bars.php?product_category=std_products" target="_blank">
                                            <h6>Duo Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Boring Kit/Introduction/Small 1.jpg" alt="Boring Kit" />
                                    <div class="mini-slider-footer">
                                        <a href="boring_kit.php?product_category=std_products" target="_blank">
                                            <h6>Boring Kit</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/BCA_Introduction/Introduction/Small 1.jpg" alt="BCA Boring Bars" />
                                    <div class="mini-slider-footer">
                                        <a href="bca_boring_bars.php?product_category=std_products" target="_blank">
                                            <h6>BCA Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="pb-50">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Other Product Offerings</h3>
                    </div>
                </div>
                <br>
                <div class="row">
                        ...
                        <div class="product-slider-box-wrapper">
                            <div class="product-slider-box slick-row-15 slick-arrow-style">
                                <div class="pro-large-img"> <img src="include/img/Semi - Finish Boring Bars - ISO Cartridge Type/Small 1.jpg" alt="Semi - Finish Boring Bars - ISO Cartridge Type" />
                                    <div class="mini-slider-footer">
                                        <a href="semi_finish_boring_bars_iso_cartridge_type.php?product_category=products" target="_blank">
                                            <h6>Boring Bars with ISO Cartridge</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Semi - Finish Boring Bars - Special Cartridge Type/Small 1.jpg" alt="Semi - Finish Boring Bars - Special Cartridge Type" />
                                    <div class="mini-slider-footer">
                                        <a href="semi_finish_boring_bars_special_cartridge_type.php?product_category=products" target="_blank">
                                            <h6>Boring Bars with Spl. Cartridge</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Fixed Pocket Type Rough Boring Bars (Core Drills)/Small 1.jpg" alt="Fixed Pocket Type Rough Boring Bars (Core Drills)" />
                                    <div class="mini-slider-footer">
                                        <a href="rough_boring_bars_fixed_pocket_type.php?product_category=products" target="_blank">
                                            <h6>Fixed Pocket Type Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Antivibration Boring Bars/Small 1.jpg" alt="Antivibration Boring Bars" />
                                    <div class="mini-slider-footer">
                                        <a href="antivibration_boring_bars.php?product_category=products" target="_blank">
                                            <h6>Antivibration Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Back Boring Bars-Back Spot Facing Tools/Small 1.jpg" alt="Back Boring Bars-Back Spot Facing Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="back_boring_bars.php?product_category=products" target="_blank">
                                            <h6>Back Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Combination Boring Bars/Small 1.jpg" alt="Combination Boring Bars" />
                                    <div class="mini-slider-footer">
                                        <a href="combination_boring_bars.php?product_category=products" target="_blank">
                                            <h6>Combination Boring Bars</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Face Milling Cutters/Small 1.jpg" alt="Face Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_face_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Face Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Modular Milling Cutters/Small 1.jpg" alt="Modular Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_modular_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Modular Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Shoulder Milling Cutters/Small 1.jpg" alt="Shoulder Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_shoulder_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Shoulder Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Full - Half - Side & Face Milling Cutters/Small 1.jpg" alt="Side & Face Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_full_Half_side_and_face_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Side & Face Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/T - Slot Milling Cutters/Small 1.jpg" alt="T - Slot Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_t_slot_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>T - Slot Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/45° Approach Angle Milling Cutters/Small 1.jpg" alt="45° Approach Angle Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_45_approach_angle_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>45° Angle Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/End Mill Cutters/Small 1.jpg" alt="End Mill Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_end_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>End Mill Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Thread Mill Cutters/Small 1.jpg" alt="Thread Mill Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="milling_cutters_thread_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Thread Mill Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Dovetail Taper Angle Milling Cutters/Small 1.jpg" alt="Dovetail Milling Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="dovetail_taper_angle_milling_cutters.php?product_category=products" target="_blank">
                                            <h6>Dovetail Milling Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Spot Face Cutters/Small 1.jpg" alt="Spot Face Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="spot_face_cutters.php?product_category=products" target="_blank">
                                            <h6>Spot Face Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Centre Spot Face Cutters/Small 1.jpg" alt="Centre Spot Face Cutters" />
                                    <div class="mini-slider-footer">
                                        <a href="centre_spot_face_cutters.php?product_category=products" target="_blank">
                                            <h6>Centre Spot Face Cutters</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/U - Drills/Small 1.jpg" alt="U - Drills" />
                                    <div class="mini-slider-footer">
                                        <a href="drilling_tools_u_drills.php?product_category=products" target="_blank">
                                            <h6>U - Drills</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Trepanning Tools/Small 1.jpg" alt="Trepanning Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="drilling_tools_trepanning_drills.php?product_category=products" target="_blank">
                                            <h6>Trepanning Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Fixed Pocket Type Chamfer Tools/Small 1.jpg" alt="Fixed Pocket Type Chamfer Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="chamfer_tools_fixed_pocket_type_chamfer_tools.php?product_category=products" target="_blank">
                                            <h6>Fixed Pocket Type Chamfer Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Adjustable Diameter Chamfer Tools - Duo Chamfering Tools/Small 1.jpg" alt="Adjustable Diameter Chamfer Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="chamfer_tools_adjustable_diameter_chamfer_tools_duo_chamfering_tools.php?product_category=products" target="_blank">
                                            <h6>Adjustable Diameter Chamfer Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Cartridge Type Chamfer Tools/Small 1.jpg" alt="Cartridge Type Chamfer Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="chamfer_tools_cartridge_type_chamfer_tools.php?product_category=products" target="_blank">
                                            <h6>Cartridge Type Chamfer Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Finish Boring Cartridges/Small 1.jpg" alt="Finish Boring Cartridges" />
                                    <div class="mini-slider-footer">
                                        <a href="cartridges_finish_boring_cartridges.php?product_category=products" target="_blank">
                                            <h6>Finish Boring Cartridges</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Special Cartridges/Small 1.jpg" alt="Special Cartridges" />
                                    <div class="mini-slider-footer">
                                        <a href="cartridges_special_cartridges.php?product_category=products" target="_blank">
                                            <h6>Special Cartridges</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/ISO Cartridges/Small 1.jpg" alt="ISO Cartridges" />
                                    <div class="mini-slider-footer">
                                        <a href="cartridges_iso_cartridges.php?product_category=products" target="_blank">
                                            <h6>ISO Cartridges</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/ID Boring Tools/Small 1.jpg" alt="ID Boring Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_id_boring_tools.php?product_category=products" target="_blank">
                                            <h6>ID Boring Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/OD Turning Tools/Small 1.jpg" alt="OD Turning Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_od_turning_tools.php?product_category=products" target="_blank">
                                            <h6>OD Turning Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Face Grooving Tools/Small 1.jpg" alt="Face Grooving Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_face_grooving_tools.php?product_category=products" target="_blank">
                                            <h6>Face Grooving Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/ID Grooving Tools/Small 1.jpg" alt="ID Grooving Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_id_grooving_tools.php?product_category=products" target="_blank">
                                            <h6>ID Grooving Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Grooving & Parting Tools/Small 1.jpg" alt="Grooving & Parting Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_grooving_and_parting_tools.php?product_category=products" target="_blank">
                                            <h6>Grooving & Parting Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Threading Tools/Small 1.jpg" alt="Threading Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_threading_tools.php?product_category=products" target="_blank">
                                            <h6>Threading Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Combination Turning Tools/Small 1.jpg" alt="Combination Turning Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_combination_turning_tools.php?product_category=products" target="_blank">
                                            <h6>Combination Turning Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Anti-vibration Turning Tools/Small 1.jpg" alt="Anti-vibration Turning Tools" />
                                    <div class="mini-slider-footer">
                                        <a href="turning_tools_anti_vibration_turning_tool.php?product_category=products" target="_blank">
                                            <h6>Anti-vibration Turning Tools</h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="pro-large-img"> <img src="include/img/Special Adaptors/Small 1.jpg" alt="Special Adaptors" />
                                    <div class="mini-slider-footer">
                                        <a href="special_adaptors.php?product_category=products" target="_blank">
                                            <h6>Special Adaptors</h6>
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="pb-50">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Why us</h3>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="product-slider-box-wrapper">
                                <div class="product-slider-box slick-row-15 slick-arrow-style">
                                    ...
                                    <div class="pro-large-img"> <img src="include/img/why us/Company_Profile.jpeg" alt="State of The art Manufacturing facility" />
                                        <div class="mini-slider-footer">
                                            <h6>State of The art Manufacturing facility</h6>

                                        </div>
                                    </div>
                                    <div class="pro-large-img"> <img src="include/img/why us/lead-time.jpg" alt="Shortest Lead Time" />
                                        <div class="mini-slider-footer">
                                            <h6>Shortest Lead Time</h6>
                                        </div>
                                    </div>
                                    <div class="pro-large-img"> <img src="include/img/why us/Lowest Price.jpeg" alt="Lowest Possible Price" />
                                        <div class="mini-slider-footer">
                                            <h6>Lowest Possible Price</h6>
                                        </div>
                                    </div>
                                    <div class="pro-large-img"> <img src="include/img/why us/Technolgy_image.jpeg" alt="Best In Class Technology" />
                                        <div class="mini-slider-footer">
                ...
                <div class="pb-50">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Testimonials & Reviews</h3>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                <div class="carousel-inner text-center">
                                    ...
                                    <div class="item active" style="border: 2px solid #2a80b91c;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h6><span style="font-size: 16px;">"</span>We are thankful and grateful in support to Renuka Tools. We loved the products from Renuka Tools as they are of very high quality. Pre-sales & post-sales support is excellent. Will definitely promote the company in my network.<span style="font-size: 16px;">"</span></h6> <b>Raju D. Kawa ( Kawa Machine Tools )</b>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item" style="border: 2px solid #2a80b91c;">
                                        <div class="row">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-6">
                                                <h6><span style="font-size: 16px;">"</span> Renuka tools is a vibrant organization which takes up challenging projects. We had developed a complex forging tool which required 5 axis machining and it was developed successfully. Wish them all the best.<span style="font-size: 16px;">"</span></h6> <b>Dr. Vasant Khisty ( Sammy Consulting )</b>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item" style="border: 2px solid #2a80b91c;">
                                        <div class="row">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-6">
                                                <h6><span style="font-size: 16px;">"</span> I am thankful to work with Renuka Tools as it supports us to deliver lots of customized tools along with accuracy and productivity. Their supports regarding tools urgency and sales are too much appreciable and fast. Best wishes to them for the long run.<span style="font-size: 16px;">"</span></h6> <b>Md Khairul Hassan ( 1st Sr. Deputy Director,Dept. of R&D Compressor,Walton Hi-Tech Industry Ltd.,Bangladesh)</b>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
                                    </div>
                                ...
                                <a data-slide="next" href="#quote-carousel" class="right carousel-control"><i class="fa fa-chevron-circle-right" style="color: #2a80b9;font-size: 20px;"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pb-50">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Our Valuable Customers</h3>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                ...
                <div class="pb-50">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="entry-title" style="font-size: 20px;font-weight: bolder;">Statistics</h3>
                        </div>
                    </div>
                    <br>
                    <div class="row">
